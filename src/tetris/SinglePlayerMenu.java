...
public class SinglePlayerMenu extends Menu {
    ...
    Scene mainMenu;
    Scene play;
    public static String[] bgString = {"bg15.jpg", "bg3.jpg", "bg5.jpg"};

    public static String[] list = {"NOMAL", "EXHAUTED", "BACK"};

    public SinglePlayerMenu(Stage primaryStage, String label, String color, String font) {
        super(primaryStage, bgString, label, list, color, font);
        SinglePlayer.setBackScene(scene);
        play = SinglePlayer.createScene(primaryStage);
    ...
    public void setMode() {
        ...
        SinglePlayer.setVirtualPiece(Setting.isVirtualPiece);
        SinglePlayer.setNextPiece(Setting.isNextPiece);
    }
    ...
    public void rule() {
        ...
        role.add(() -> {
            SinglePlayer.getBoard().setName(Name.name);
